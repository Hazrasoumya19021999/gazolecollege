        ...
        <>
            {
                loading ? <LoadingAnimation /> :
                    <WebView source={{ uri: 'https://mcerp.in/erp/StudentPortal/StudentDigitalIDCard.aspx?StudentId=' + parseInt(studentid) }}
                        injectedJavaScript={`
...
function LoadingAnimation() {
    return (
        <View style={styles.indicatorWrapper}>
            ...
            <Text style={styles.indicatorText}>Loading My I Card...</Text>
        </View>
    );
}
