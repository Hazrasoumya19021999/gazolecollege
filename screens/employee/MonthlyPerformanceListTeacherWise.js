...
const MonthlyPerformanceListTeacherWise = () => {
        ...
        <SafeAreaView style={styles.container}>
            {error ? (
                ...
                <View style={styles.webviewWrapper}>
                    ...
                    <WebView
                        source={{ uri: `https://mcerp.in/erp/mobilewebview/MonthlyPerformanceListWebview.aspx?TeacherId=${teacherId}` }}
...
export default MonthlyPerformanceListTeacherWise;
